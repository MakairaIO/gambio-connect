            ...
            if (empty($t_uninitialized_array)) {
                switch ($p_action) {
                    case 'search_result':
                        ...
                        $coo_filter_selection_content_view = MainFactory::create_object(
                            'FilterSelectionThemeContentView'
                        );
                        $coo_filter_selection_content_view->set_(
                            'feature_value_group_array',
                            $t_feature_value_group_array
                        );
                ...
                if ($coo_listing_split->number_of_rows > 0) {
                    ...
                    $t_category_heading_title = $category['heading_title'];
                    $t_category_image_alt_text = $category['image_alt_text'];
                    $t_category_image = $category['image'];
                    $t_show_category_image = $category['show_categories_image_in_description'];
                    $t_categories_description = $category['description'];
                    $t_categories_description_bottom = $category['description_bottom'];
                    $t_category_show_quantity = $category['category_show_quantity'];
                    ...
                    foreach ($coo_listing_split->products as $t_product_array) {
                        ...
                        if (!$coo_product->data) {
                            $bannerData = [];
                            /* Desktop Image */
                            //$t_product_array['products_image'] = $t_products_array['imageDesktop'];
                            /* Mobile Image */
                            //$t_product_array['products_image'] = $t_products_array['imageMobile'];
                        ...
                        if (
                            ...
                            $c_template = $coo_product_attributes->get_default_template(
                                $t_filepath,
                                'product_listing_option_template_',
                                $coo_product->data['gm_options_template']
                            );
                        ...
                        if ($t_category_data_array['show_graduated_prices']) {
                            ...
                            $coo_graduated_prices->set_customers_status_graduated_prices(
                                $_SESSION['customers_status']['customers_status_graduated_prices']
                            );
                    ...
                    if ((defined('CURRENT_THEME') && !empty(CURRENT_THEME)) || (defined(
                                'PREVIEW_MODE'
                            ) && PREVIEW_MODE)) {
                    ...
                    $categoryDescriptionBottomContentView = MainFactory::create(
                        'CategoryDescriptionBottomThemeContentView'
                    );
                    $categoryDescriptionBottomContentView->set_content_data(
    ...
    public function get_category_data_array()
    {
        return [
            'description_bottom' => trim(
                $this->category->fields->categories_description_bottom
            ) === '<br />' ? '' : $this->category->fields->categories_description_bottom,
            'description' => trim(
                $this->category->fields->categories_description
            ) === '<br />' ? '' : $this->category->fields->categories_description,
            'name' => $this->category->fields->categories_name,
            'heading_title' => $this->category->fields->categories_heading_title,
            'image_alt_text' => $this->category->fields->categories_heading_title,
            'image' => '',
            'show_categories_image_in_description' => $this->category->fields->show_categories_image_in_description,
            'gm_show_attributes' => $this->category->fields->gm_show_attributes,
            'listing_template' => $this->category->fields->listing_template,
