...
class MakairaProduct extends MakairaDocument
{
    ...
    public function __construct(array $product, ProductVariants $variants, bool $delete = false, array $options = [])
    {
        ...
        array_push($this->makairaDocument, $this->mapProduct());

        foreach ($this->variants as $variant) {
            array_push($this->makairaDocument, $this->mapVariant($variant));
        }
    }
