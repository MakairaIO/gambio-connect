...
class MakairaConnectWelcome extends AdminModuleAction
{
    ...
    public function handle(Request $request, Response $response): Response
    {
        ...
        $data = [
            'welcomeJs' => "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/welcome.js",
            'welcomeCss' => "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/welcome.css",
            'logo'       => "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/logo.svg",
            ...
            'companies' =>  [
                "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/hark.png",
                "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/fielmann.png",
                "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/ludwing_von_kapff.svg",
                "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/geliebteszuhause.png",
                "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/wallart.svg",
                "{$this->url->base()}/GXModules/Makaira/MakairaConnect/Admin/ui/assets/pets_premium.png",
            ]
        ];
