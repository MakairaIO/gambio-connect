...
class Ruleset
{
    ...
    public function explain()
    {
        ...
        foreach ($sniffs as $i => $sniff) {
            ...
            if ($currentStandard !== $lastStandard) {
                ...
                echo Ruleset . phpstr_repeat('-', strlen($subTitle)) . PHP_EOL;
    ...
    public function showSniffDeprecations()
    {
        ...
        echo Ruleset . phpstr_repeat('-', min(($maxActualWidth + 4), $reportWidth)) . PHP_EOL;
    ...
    public function processRuleset($rulesetPath, $depth=0)
    {
        ...
        foreach ($ruleset->{'autoload'} as $autoload) {
            ...
            $relativePath = Util\Common::realPath(Ruleset . phpdirname($rulesetPath) . DIRECTORY_SEPARATOR .$autoloadPath);
            ...
            if ($path !== null) {
                ...
                if ($stdPath !== null && $path !== '') {
                    if (Util\Common::isPharFile($stdPath) === true
                        ...
                        $newRef = Util\Common::realpath(Ruleset . phpdirname($stdPath) . $path);
                    }
                }
