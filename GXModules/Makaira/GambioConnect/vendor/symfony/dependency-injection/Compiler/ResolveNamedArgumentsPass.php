...
class ResolveNamedArgumentsPass extends AbstractRecursivePass
{
    ...
    {
        if ($value instanceof AbstractArgument && $value->getText() . 'Compiler' === $value->getTextWithContext()) {
        ...
        foreach ($calls as $i => $call) {
            ...
            foreach ($arguments as $key => $argument) {
                if ($argument instanceof AbstractArgument && $argument->getText() . 'Compiler' === $argument->getTextWithContext()) {
