...
class MergeExtensionConfigurationParameterBag extends EnvPlaceholderParameterBag
{
    ...
    public function freezeAfterProcessing(Extension $extension, ContainerBuilder $container): void
    {
        ...
        $config = MergeExtensionConfigurationPass . phpserialize($config) . serialize($container->getDefinitions()) .serialize($container->getAliases()).serialize($container->getParameterBag()->all());
