<?php
/* --------------------------------------------------------------
   split_page_results.php 2019-07-30
   Gambio GmbH
   http://www.gambio.de
...
{
    public $sql_query, $products = [], $number_of_rows, $current_page_number, $number_of_pages, $number_of_rows_per_page;
    ...
    // class constructor
    public function __construct(\GXModules\Makaira\GambioConnect\App\MakairaClient $makairaClient, int $categoryId, $products, $page, $max_rows)
    {
        $this->sql_query = '';
    ...
    public function setPrevNextUrls()
    {
        ...
        $GLOBALS['relNextUrl'] = $this->relNextUrl;
    }
    ...
    {
        if ($parameters === null) {
            $parameters = xtc_get_all_get_params([
                'page',
                'info',
                'x',
                'y',
        ...
        return xtc_href_link($t_href_link_base, $parameters, $request_type);
    }
}
