...
class GambioConnectCategoriesDescriptionTableInstaller implements GambioConnectTableInstallerInterface
{
    ...
    {
        $connection->executeStatement("DROP TRIGGER IF EXISTS makaira_connect_categories_description_create_trigger");

        $connection->executeStatement("DROP TRIGGER IF EXISTS makaira_connect_categories_description_update_trigger");

        $connection->executeStatement("DROP TRIGGER IF EXISTS makaira_connect_categories_description_delete_trigger");
    }
}
